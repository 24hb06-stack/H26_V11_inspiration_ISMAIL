...
>Image prise du site web de Centre des sciences de Montréal
...
La firme de cette exposition est le Centre des sciences de Montréal, en collaboration avec des partenaires autochtones et scientifiques.
...
- Si vous pouvez frapper la glace 3 fois avec la lance sans qu’elle se brise ou présente des fissures, cela signifie qu’elle est assez épaisse pour traverser. Sinon, vous devez éviter la zone et essayer un autre chemin,   ou vous perdez une vie.

- Vous devez éviter les obstacles tels que les ours polaires, sinon vous perdez une vie.

- Vous devez terminer le voyage avant la tombée de la nuit, sinon le jeu se termine automatiquement et vous perdez.
...
#### Pour la fonction du dispositif multimédia, il comporte 4 aspects.
...
L’espace occupé pour cette œuvre est assez grand. Il se compose de deux sections. La première section contient un écran expliquant l’utilisation de l’unaaq et comment s’en servir. La deuxième section est la principale attraction : on y trouve un grand écran affichant le jeu. Devant cet écran se trouve la lance, qui sert à contrôler le personnage. Et c’est à peu près tout. 
